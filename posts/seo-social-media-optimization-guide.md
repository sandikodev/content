...
Anda baru saja merilis artikel hebat, membagikannya ke WhatsApp atau Facebook, tapi yang muncul hanyalah tautan teks biru yang membosankan? Tidak ada gambar kover, tidak ada deskripsi menarik. Ini adalah mimpi buruk bagi *click-through rate* (CTR) Anda.
...
Hari ini, kita akan bedah tuntas cara menguasai *Social Media Preview* dan dasar-dasar SEO modern.
...
> **Tips:** WhatsApp menggunakan engine yang sama dengan Facebook. Jika di Facebook Debugger sudah benar, maka di WhatsApp pun akan segera pulih.

### X (Twitter) Post Inspector
Hampir sama dengan Facebook, [X Post Inspector](https://cards-dev.twitter.com/validator) memungkinkan Anda melihat bagaimana *Twitter Card* Anda akan muncul. Gunakan ini untuk memastikan meta tag `twitter:card` dan `twitter:image` terbaca dengan benar.
...
2. **Preload Fonts**: Pastikan font tidak menyebabkan *layout shift* (CLS). Gunakan `rel="preload"` untuk font utama Anda.
